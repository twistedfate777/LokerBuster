  ...
  return (
    <group ref={groupRef} position={[0, -1, 0]}>
      ...
      <group position={[0, 0, 0]}>
        {type == 1 && <DataEntryNode position={[0, 0, 0]} />}
        {type == 2 && <AIDeepScanNode position={[0, 0, 0]} />}
        {type == 3 && <SafetyVerdictNode position={[0, 0, 0]} />}
      </group>
    </group>
  );
};

const DiagramPlane = ({ type }) => {
...
export default function ScaleDiagramSolo({ type }) {
  return (
